...
def export_file(article, id, part, pubannotation, divid):
    ...
    path = "/mnt/c/Users/Sonja/OneDrive/Dokument/Skola/Projektkurs/edan70/testa/" + name + '.json'
...
def main():
    ...
    '''
    print("Starting generating pubannotation files.\n")
    n = 1
    metadata = get_metadata()
    
    for article in all_articles:
        if article != '.DS_Store':
            abbreviations = [] #reset global abbreviation list for each article
